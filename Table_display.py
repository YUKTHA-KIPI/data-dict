    ...
    if "active_session" in st.session_state:
        ...
        if grid_tb["selected_rows"]:
            ...
            if sel_row:    
                ...
                joins = run_query(f"SELECT F.FKCOLUMN_NAME AS FKEY_COLUMN_NAME,F.PKTABLE_NAME AS REFERENCE_TABLE, F.PKCOLUMN_NAME AS REFERENCE_COLUMN, T.TABLE_SCHEMA AS REFERENCE_TABLE_SCHEMA FROM DATA_DICT.PUBLIC.FKEYS F JOIN DATA_DICT.PUBLIC.TABLE_METADATA T ON T.TABLE_NAME=F.PKTABLE_NAME WHERE F.FKTABLE_NAME='{table}';")
